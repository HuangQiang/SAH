...
// -----------------------------------------------------------------------------
void SA_ALSH::lower_bounds_computation(// compute lower bounds for user_set
...
// -----------------------------------------------------------------------------
void SA_ALSH::update_lower_bound(   // update lower bound
    int   k,                            // top-k value
...
// -----------------------------------------------------------------------------
void SA_ALSH::blocking_user_set()   // split the user_set into blocks
{
...
// -----------------------------------------------------------------------------
void SA_ALSH::blocking_item_set(    // split the rest item_set into blocks
    int   n,                            // item cardinality
...
// -----------------------------------------------------------------------------
void SA_ALSH::add_block_by_items(   // add one block by items
...
// -----------------------------------------------------------------------------
void SA_ALSH::reverse_kmips(        // reverse k-mips
    int   k,                            // top k value
...
// -----------------------------------------------------------------------------
void SA_ALSH::reverse_kmips_wo_user_blocks(// reverse k-mips without user blocks
    int   k,                            // top k value
    const float *query,                 // query vector
    std::vector<int> &result)           // reverse k-mips result (return)
{
