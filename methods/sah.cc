...
// -----------------------------------------------------------------------------
void SAH::compute_norm_and_sort(    // compute l2-norm and sort (descending)
...
// -----------------------------------------------------------------------------
void SAH::blocking_user_set(        // split the user_set into blocks
...
// -----------------------------------------------------------------------------
void SAH::lower_bounds_computation( // compute lower bounds for users
...
// -----------------------------------------------------------------------------
void SAH::update_lower_bound(       // update lower bound
    int   k,                            // top-k value
...
// -----------------------------------------------------------------------------
void SAH::node_lower_bounds_computation(// compute lower bound for a node
    int   m,                            // number of users
...
// -----------------------------------------------------------------------------
void SAH::blocking_item_set(        // split the rest item_set into blocks
    int   n,                            // item cardinality
...
// -----------------------------------------------------------------------------
void SAH::add_block_by_items(       // add one block by items
...
// -------------------------------------------------------------------------
void SAH::display()                 // display parameters
{
    printf("Parameters of SAH:\n");
    printf("n             = %d\n",   n_);
    printf("m             = %d\n",   m_);
    printf("d             = %d\n",   d_);
    printf("k_max         = %d\n",   k_max_);
...
// -----------------------------------------------------------------------------
void SAH::reverse_kmips(            // reverse k-mips
    int   k,                            // top k value
