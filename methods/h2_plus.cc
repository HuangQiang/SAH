...
// -----------------------------------------------------------------------------
void H2_PLUS::compute_norm_and_sort(// compute l2-norm and sort (descending)
...
// -----------------------------------------------------------------------------
void H2_PLUS::lower_bounds_computation(// compute lower bounds for user_set
...
// -----------------------------------------------------------------------------
void H2_PLUS::update_lower_bound(   // update lower bound
    int   k,                            // top-k value
...
// -----------------------------------------------------------------------------
void H2_PLUS::blocking_user_set()   // split the user_set into blocks
{
...
// -----------------------------------------------------------------------------
void H2_PLUS::blocking_item_set(    // split the rest item_set into blocks
    int   n,                            // item cardinality
...
// -----------------------------------------------------------------------------
void H2_PLUS::add_block_by_items(   // add one block by items
...
// -------------------------------------------------------------------------
void H2_PLUS::display()             // display parameters
{
    printf("Parameters of H2_PLUS:\n");
    printf("n             = %d\n",   n_);
    printf("m             = %d\n",   m_);
    printf("d             = %d\n",   d_);
    printf("k_max         = %d\n",   k_max_);
...
// -----------------------------------------------------------------------------
void H2_PLUS::reverse_kmips(        // reverse k-mips
    int   k,                            // top k value
...
// -----------------------------------------------------------------------------
void H2_PLUS::reverse_kmips_wo_user_blocks(// reverse k-mips without user blocks
    int   k,                            // top k value
    const float *query,                 // query vector
    std::vector<int> &result)           // reverse k-mips result (return)
{
